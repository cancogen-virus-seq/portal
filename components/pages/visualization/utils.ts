...
export const CovizuContainer = styled('div')`
  margin: 40px;
...
----------------------------------*/
  ...
  * {
  ...
  body {
    font: 0.9em/1.2 Lato, sans-serif;
  }
  ...
  div.hint {
    font-size: 0.8em;
    color: #5e5e5e;
    padding: 3px 0 12px 0; /* top right bottom left */
  }
  ...
  /* Keeps the entire "Edge cutoff" section together */
  div.edge-cuttoff {
    display: inline-flex;
    flex-wrap: wrap;
    gap: 3px;
  ...
  .beadplot-content::-webkit-scrollbar {
    display: none;
  }
  ...
  /*
div.middlebox::-webkit-scrollbar {
  display: none;
}
 */
  ...
  rect.SelectedCluster {
    fill-opacity: 0.9;
  }

  rect.not_SelectedCluster {
    fill-opacity: 0.1;
  }

  rect.clicked {
    fill-opacity: 1;
    filter: saturate(1.2) brightness(0.85) contrast(135%);
  }

  rect.SelectedCluster:hover {
    stroke: gray;
    stroke-width: 2;
  }

  rect.not_SelectedCluster.clicked {
    fill-opacity: 0.1;
  }
  ...
  rect.SelectedCluster[txt_hover='yes'] {
    stroke: gray;
    stroke-width: 2;
  }
...
*/
  ...
  /* Horizontal scrollbar for beadplot */
  #beadplot-hscroll {
    overflow-x: scroll;
    overflow-y: hidden;
    height: 16px;
  ...
  /* Vertical scrollbar for beadplot */
  #beadplot-vscroll {
    overflow-x: hidden;
    overflow-y: scroll;
    width: 20px;
  ...
  table {
    ...
    font: 0.775em/1.2 Lato, sans-serif;
  }
  ...
  /* Toogle Switch - https://www.w3schools.com/howto/howto_css_switch.asp */
  .switch {
    position: relative;
    display: inline-block;
    width: 31px;
