...
const Covizu = () => {
  return (
    <CovizuContainer>
      <p>test</p>
      {/* <div>
        <div className="tooltip" id="tooltipContainer" />
        <div className="app">
            ...
            >
              <div className="legend-container">
                ...
                <select name="tree-colours" id="select-tree-colours">
                  ...
                  <option value="Divergence" selected>
                    Divergence
                  </option>
                </select>
                <div className="legend" id="div-region-legend" />
                <div className="legend" id="svg-sample-legend" />
                <div className="legend" id="svg-coldate-legend" />
                <div className="legend" id="svg-diverge-legend" />
              </div>

              <div className="search-bar-container">
                <div id="search-bar">
                  <input type="search" id="search-input" placeholder="e.g., B.1.617 or Manitoba" />
                ...
                <div
                  ...
                  `}
                >
                  <img id="loading" src="images/covizu-loading.gif" />
            ...
            <div className="sticky">
              ...
              <div className="rightbox">
                ...
                <p>
                  ...
                  <div
                    css={css`
                      font-size: 0.9em;
                    `}
                    id="div-number-genomes"
                  />
                  <div
                    css={css`
                      font-size: 0.9em;
                    `}
                    id="div-number-lineages"
                  />
                </p>
                ...
                <div id="tabs">
                  ...
                  <div id="tabs-1">
                    <div className="breaker" id="barplot" />
                    <div
                      css={css`
                        overflow-y: auto;
                        overflow-x: hidden;
        ...
        <div id="splash" title="Welcome">
          ...
          <p>
            ...
            (groupings of viruses with similar genomes, useful for linking outbreaks in different
            places;{' '}
          ...
          <p>
            Selecting a lineage displays a "beadplot" visualization in the centre of the page. Each
            horizontal line represents one or more samples of SARS-CoV-2 that share the same genome
            sequence. Beads along the line represent the dates that this variant was sampled.
          </p>
          <p>
        ...
        <div id="help-timetree" title="Help: Time-scaled tree interface">
          ...
          <p>
            ...
            descendants are on the right. We estimate the dates of common ancestors by comparing the
            sampled genomes and assuming a{' '}
            <a
          ...
          <p>
            For each lineage, we draw a rectangle to summarize the range of sample collection dates,
            and colour it according to the geographic region it was sampled most often. To explore
            the samples within a lineage, click on the label (<i>e.g.,</i> "B.4") or the rectangle
            to retrieve the associated beadplot.
          </p>
        </div>
        ...
        <div id="help-beadplot" title="Help: Beadplot interface">
          <p>
            ...
            , where and when they have been sampled, and how they are related to each other. Every
            object in the beadplot has additional info in a tooltip (which you view by hovering over
            that object with your mouse pointer).
          </p>
          <p>
            ...
            genomes. We draw beads along a line to indicate when that variant was sampled. If there
            are no beads on the line and it is grey, then it is an unsampled variant: two or more
            sampled variants descend from an ancestral variant that has not been directly observed.
          </p>
          <p>
          ...
          <p>
            ...
            report the number of genetic differences (mutations) between ancestor and descendant as
            the "genomic distance". Since it's difficult to reconstruct exactly when these mutations
            occurred, we simply map each line to when the first sample was collected.
          </p>
        </div>
        ...
        <div id="help-search" title="Help: Search interface">
          <p>
            ...
            visualize here, we have built a basic search interface that you can interact with using
            the inputs at the top of this web page.
          </p>
          <p>
            You can use the text box to find a specific sample by GISAID accession number. If you
            start to enter an accession number, the text box will display a number of possibilities
            (autocompletion). You can also search samples by substring (case-sensitive). For
            example, searching for "Madaga" (hit enter to submit) will jump to the first lineage
            that contains a sample from Madagascar.
          </p>
          <p>
            Use the "Previous" and "Next" buttons to iterate through your search results, and the
            "Clear" button to reset the search interface.
          </p>
        </div>
      </div> */}
    </CovizuContainer>
